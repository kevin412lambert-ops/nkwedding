...
export default function WeddingWebsite() {
  ...
  const handleRsvpSubmit = async () => {
    ...
    try {
      ...
      discordMessage += `\n[View Google Sheet](${GOOGLE_SHEET_LINK})`;
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex gap-3 pt-4">
                    ...
                    <button
                      ...
                      className={`flex-1 bg-gradient-to-r from-teal-600 to-purple-600 text-white px-6 py-3 rounded-lg hover:from-teal-700 hover:to-purple-700 transition-all shadow-lg font-medium ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''}`}
                    >
