        ...
        <div className="max-w-6xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between lg:justify-center">
            <button 
              ...
              className="text-2xl font-serif text-purple-900 hover:text-teal-600 transition-colors cursor-pointer lg:absolute lg:left-4"
            >
              N & K
            </button>
          ...
          <div className="hidden lg:flex gap-8 justify-center mt-2">
          ...
          <div className="max-w-4xl mx-auto px-4 py-16">
            ...
            <div className="bg-white rounded-lg shadow-xl p-8 mt-8 border-2 border-teal-300">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-4 items-start">
                  <div className="text-teal-600 font-semibold min-w-24">5:00 PM</div>
                  <div>
                ...
                <div className="flex gap-4 items-start">
                  <div className="text-purple-600 font-semibold min-w-24">6:00 PM</div>
                  <div>
                ...
                <div className="flex gap-4 items-start">
                  <div className="text-teal-600 font-semibold min-w-24">8:00 PM</div>
                  <div>
                ...
                <div className="flex gap-4 items-start">
                  <div className="text-purple-600 font-semibold min-w-24">11:00 PM</div>
                  <div>
