...
export default function WeddingWebsite() {
  ...
  const handleRsvpSubmit = async () => {
    ...
    const googleSheetsUrl = 'https://script.google.com/macros/s/AKfycbzQF99P_YolhgAoe2aO_NRhuE8Pny1VPZqPdceSAyb8riP3UGA3DhuOzjNpwolH3xkn/exec';
    ...
    try {
      ...
      discordMessage += `\n[View Google Sheet](https://script.google.com/macros/s/AKfycbzQF99P_YolhgAoe2aO_NRhuE8Pny1VPZqPdceSAyb8riP3UGA3DhuOzjNpwolH3xkn/exec)`;
  ...
  const handleAddressSubmit = async (e) => {
    ...
    const discordWebhookUrl = 'https://discord.com/api/webhooks/1425237710326730892/zM6-dBciuEIeOv9QNGaZ4sh2twrAqu1sGoBd069P0iuXJN1ZMe0AGOkgjv8g2RTI7RJO';
